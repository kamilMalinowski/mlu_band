      ...
      <section className="music-player__audio-panel">
        ...
        <div className="music-player__progress-panel">
          <div className="music-player__progress-track">
            ...
            <div className="music-player__progress-bar" style={{
    width: duration ? `${(currentTime / duration) * 100}%` : "0%",
  }}></div>
          </div>
          <button
            className="music-player__play-btn music-player__play-btn--temporary"
            onClick={handlePrev}
          >
            <svg
              width="20"
          ...
          <button className="music-player__play-btn" onClick={handlePlayPause}>
